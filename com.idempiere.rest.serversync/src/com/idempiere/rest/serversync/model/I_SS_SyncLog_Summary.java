...
/** Generated Interface for SS_SyncLog_Summary
 *  @author iDempiere (generated) 
 *  @version Release 12
 */
@SuppressWarnings("all")
public interface I_SS_SyncLog_Summary 
{

    /** TableName=SS_SyncLog_Summary */
    public static final String Table_Name = "SS_SyncLog_Summary";
    ...
    public static final String COLUMNNAME_FailedCount = "FailedCount";
    ...
    /** Column name SS_SyncLog_Summary_ID */
    public static final String COLUMNNAME_SS_SyncLog_Summary_ID = "SS_SyncLog_Summary_ID";
    ...
    /** Column name SS_SyncLog_Summary_UU */
    public static final String COLUMNNAME_SS_SyncLog_Summary_UU = "SS_SyncLog_Summary_UU";
    ...
    /** Column name SS_SyncTable_ID */
    public static final String COLUMNNAME_SS_SyncTable_ID = "SS_SyncTable_ID";
    ...
    public static final String COLUMNNAME_SuccessCount = "SuccessCount";
